 ...
 * 
 * TIP: How can you look for and replace a space in a String? How can
 *      you enforce lowercase? Look at the global replace link below,
 *      or try String methods split and join?
 *      
...
/** 
 * Given an input String and a single character, return true if the 
 * String ends with the character, false otherwise. The Function is
 * case insensitive.
 * 
 * Example:
 *  
 ...
 * 
 * TIP: How can you use Array access to your advantage here? How can
 *      you ensure uppercase and lowercase can be compared equally?
 */
 ...
 * 
 * TIP: This Function pulls out all the arguments passed to it and 
 *      stores them in an Array called args. 
 * 
